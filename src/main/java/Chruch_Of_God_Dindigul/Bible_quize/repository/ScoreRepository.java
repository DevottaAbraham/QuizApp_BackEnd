...
public interface ScoreRepository extends JpaRepository<Score, Long> {
    ...
    @Query("SELECT new Chruch_Of_God_Dindigul.Bible_quize.dto.LeaderboardDTO(s.user.username, SUM(s.scoreValue)) FROM Score s GROUP BY s.user.username ORDER BY SUM(s.scoreValue) DESC")
